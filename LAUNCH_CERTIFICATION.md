...
**65 requirements are cited in contracts but named in no test.**

**Method caveat, stated because it bounds the finding.** This measures *citation*,
not behaviour. A requirement may be tested without being named — VF-RAC shows 0
test citations, yet `05_staking_lifecycle` and `07_stake_rewards` exercise the
credit and epoch machinery. Conversely a citation does not prove the test asserts
the requirement. The measurement establishes that no traceability artifact
